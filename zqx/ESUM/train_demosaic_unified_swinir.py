...
from data.demosaic_rgb_dataset import (
    UnifiedDemosaicEvalDataset,
    UnifiedDemosaicTrainDataset,
    VALID_BASE_PATTERNS,
    get_common_period,
)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a unified ESUM-style SwinIR for single/quad/nona demosaicing.")
    ...
    parser.add_argument("--save-dir", type=str, default="experiments/demosaic_esum_swinir")
...
def build_dataloaders(args):
    ...
    train_loader = None
    if args.train_dirs:
        train_dataset = UnifiedDemosaicTrainDataset(
    ...
    val_loader = None
    if args.val_dirs:
        val_dataset = UnifiedDemosaicEvalDataset(
            roots=args.val_dirs,
