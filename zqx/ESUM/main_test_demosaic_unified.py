...
from data.demosaic_rgb_dataset import (
    ...
    ensure_pattern_size,
    imread_rgb_float,
    raw_and_mask_to_mosaic_visual,
)
from models.network_swinir import SwinIR


def parse_args():
    parser = argparse.ArgumentParser(description="Visualize unified ESUM-style SwinIR demosaicing results.")
...
def infer_one(
    ...
    inp, raw_mosaic, pattern_mask = build_esum_input(
        gt,
